...
public class Entity {
	...
	public static BufferedImage COIN = Game.spritesheet.getSprite(288, 0, World.TILE_SIZE, World.TILE_SIZE);
	public static BufferedImage ENEMY1_RIGHT = Game.spritesheet.getSprite(288, 256, World.TILE_SIZE, World.TILE_SIZE);
	public static BufferedImage ENEMY1_LEFT = Game.spritesheet.getSprite(288, 288, World.TILE_SIZE, World.TILE_SIZE);
