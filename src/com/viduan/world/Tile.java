...
public class Tile {
	...
	public static BufferedImage TREE_EMPTY = Game.spritesheet.getSprite(0, 64, World.TILE_SIZE, World.TILE_SIZE);
	public static BufferedImage TREE = Game.spritesheet.getSprite(32, 64, World.TILE_SIZE, World.TILE_SIZE);
